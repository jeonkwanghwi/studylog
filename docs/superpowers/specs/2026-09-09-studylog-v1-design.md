...
|---|---|
| `id`, `user_id` | |
| `product_id` | `challenge_7d` \| `challenge_30d` |
...
| SKU | 기간 | 참가비 | 일일 페이백 | 완주 보너스 |
|---|---|---|---|---|
| `challenge_7d` | 7일 | ₩7,000 | ₩1,000 | — |
| `challenge_30d` | 30일 | ₩30,000 | ₩1,000 | **₩3,000** |

30일권은 전일 달성 시 **₩33,000**이 돌아온다. 장기 참여를 유도하는 훅이자,
성실한 유저가 실제로 이득을 보는 지점이다.
